...
const createFlowObject = (resource /*: Object*/) => {
  ...
  for (const propertyName of propertyNames) {
    ...
    // eslint-disable-next-line no-use-before-define
    types.push('+' + (0, _lodash.camelCase)(propertyName) + ': ' + getPropertyFlowType(property));
  }
...
const run = async () => {
  const oas = await (0, _got.default)('https://api.stoplight.io/v1/versions/9WaNJfGpnnQ76opqe/export/oas.json', {
    json: true });
